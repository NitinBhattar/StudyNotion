...
const CourseInformationForm = () => {
    ...
    // States to keep track of loading and categories
    ...
    return (
        ...
        >
            ...
            {/* tags and instructions require seperate form to convert them into array and display seperately */}
            {/* Course Tags */}
            <ChipInput
                label= "Tags"
                name= "courseTags"
