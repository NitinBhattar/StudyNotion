...
// setCourses is a useState from Instructor.jsx
const CoursesTable = ({ courses, setCourses }) => {
    // From slices
    const { token } = useSelector( (state) => state.auth );

    // States to keep track of loading and confirmation modal
    ...
    const handleCourseDelete = async (courseId) => {
        ...
        // API Call to fetch updated courses
    ...
    return (
        <div className = "">
                            ...
                            courses?.map((course) => {
                                return (
                                    ...
                                    >
                                        ...
                                        <Td className= "text-sm font-medium px-6 text-richblack-100">
            ...
            {/* When to display confirmation modal */}
